    ...
    if request.method == "POST" and request.FILES:
        ...
        try:
            ...
            with ThreadPoolExecutor() as executor:
                futures = {
                    executor.submit(process_uploaded_file, uploaded_file, selected_method, shots, is_retrieve): uploaded_file
...
def process_uploaded_file(uploaded_file, selected_method, shots, is_retrieve):
