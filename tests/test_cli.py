...
METHOD_CLI_MAPPING = {
    "frqi": CLIParameters(
        image_path="assets/test_images/grayscale/test_image.png", grayscale=True
    ),
    ...
    "qualpi": CLIParameters(
        image_path="assets/test_images/grayscale/test_flag_4x4.png", grayscale=False
    ),
}
