...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{baseline_classical_dense_classifier_input_1.png}};
...
\pic[shift={(2.6, 0.0, 0.0)}] at (0, 0, 0)
    {RightBandedBox={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Flatten + Linear\\$256 \rightarrow 10$; LogSoftmax}},
        width=1.0,
        height=3.5,
        depth=3.5,
