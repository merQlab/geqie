...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{baseline_classical_cnn_classifier_input_1.png}};
...
\pic[shift={(3.4, 0.0, 0.0)}] at (Pool_2-east)
    {Box={
        name=ConvAct_3,
        fill=\ConvColor,
        opacity=0.82,
...
\pic[shift={(3.4, 0.0, 0.0)}] at (Pool_4-east)
    {RightBandedBox={
        name=LinearAct_5,
        fill={rgb,255:red,118;green,183;blue,178},
        opacity=0.82,
        caption={\scriptsize \shortstack{Flatten + Linear\\$512 \rightarrow 64$; ReLU}},
        width=1,
        height=3.5,
        depth=3.5,
...
\pic[shift={(2.6, 0.0, 0.0)}] at (LinearAct_5-east)
    {RightBandedBox={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Linear\\$64 \rightarrow 10$; LogSoftmax}},
        width=1,
        height=3.5,
        depth=3.5,
        bandfill=\ActivationColor
