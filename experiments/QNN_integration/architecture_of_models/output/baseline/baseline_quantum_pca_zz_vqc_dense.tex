...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{baseline_quantum_pca_zz_vqc_dense_input_1.png}};
...
\pic[shift={(2.6, 0.0, 0.0)}] at (0, 0, 0)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Flatten + PCA\\$256 \rightarrow 12$}},
        width=1.25,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(2.6, 0.0, 0.0)}] at (LinearAct_1-east)
    {Box={
        name=LinearAct_2,
...
\pic[shift={(2.6, 0.0, 0.0)}] at (LinearAct_2-east)
    {RightBandedBox={
        name=LinearAct_3,
