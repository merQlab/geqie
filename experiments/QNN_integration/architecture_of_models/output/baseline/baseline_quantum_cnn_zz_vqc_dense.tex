...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{baseline_quantum_cnn_zz_vqc_dense_input_1.png}};
...
\pic[shift={(0.0, 0.0, 0.0)}] at (ConvAct_1-east)
    {Box={
        ...
        fill=\PoolColor,
        opacity=0.82,
        caption={\scriptsize \shortstack{Conv($3\!\times\!3$) + ReLU\\MaxPool($2\!\times\!2$)\\$1\!\times\!16\!\times\!16 \rightarrow 16\!\times\!8\!\times\!8$}},
        width=1.0,
        height=1.275,
        depth=1.275
        }
...
\pic[shift={(3.8, 0.0, 0.0)}] at (Pool_2-east)
    {Box={
        name=ConvAct_3,
        fill=\ConvColor,
        opacity=0.82,
...
\pic[shift={(0.0, 0.0, 0.0)}] at (ConvAct_3-east)
    {Box={
        ...
        fill=\PoolColor,
        opacity=0.82,
        caption={\scriptsize \shortstack{Conv($3\!\times\!3$) + ReLU\\MaxPool($2\!\times\!2$)\\$16\!\times\!8\!\times\!8 \rightarrow 32\!\times\!4\!\times\!4$}},
        width=1,
        height=1,
        depth=1
        }
...
\pic[shift={(4.0, 0.0, 0.0)}] at (Pool_4-east)
    {Box={
        name=LinearAct_5,
        fill={rgb,255:red,118;green,183;blue,178},
        opacity=0.82,
        caption={\scriptsize \shortstack{Flatten + Linear\\$512 \rightarrow 12$}},
        width=1,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(2.6, 0.0, 0.0)}] at (LinearAct_5-east)
    {Box={
        name=LinearAct_6,
        fill={rgb,255:red,111;green,76;blue,155},
        opacity=0.82,
        caption={\scriptsize \shortstack{$ZZ$ feature map + VQC\\$q=12$, $L=1$\\$12 \rightarrow 4096$}},
        width=2.0,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(2.6, 0.0, 0.0)}] at (LinearAct_6-east)
    {RightBandedBox={
        name=LinearAct_7,
...
\draw [connection] (Pool_4-east) -- node {\midarrow} (LinearAct_5-west);
\draw [connection] (LinearAct_5-east) -- node {\midarrow} (LinearAct_6-west);
\draw [connection] (LinearAct_6-east) -- node {\midarrow} (LinearAct_7-west);

\draw [connection] (ImgInput_1.east) -- node {\midarrow} (ConvAct_1-west);
