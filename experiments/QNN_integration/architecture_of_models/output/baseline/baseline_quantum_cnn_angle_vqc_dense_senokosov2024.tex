...
\def\ConvColor{rgb,255:red,76;green,120;blue,168}
\def\ActivationColor{rgb,255:red,245;green,133;blue,24}
\def\DropoutColor{rgb,255:red,228;green,87;blue,86}
\def\PoolColor{rgb,255:red,228;green,87;blue,86}
\def\VecInputColor{rgb,255:red,114;green,183;blue,178}
\def\LinearColor{rgb,255:red,178;green,121;blue,162}
\def\EmbeddingColor{rgb,255:red,89;green,161;blue,79}
\def\NormColor{rgb,255:red,157;green,117;blue,93}
\def\LstmColor{rgb,255:red,121;green,112;blue,110}
\def\EdgeColor{rgb,255:red,61;green,64;blue,91}
...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{baseline_quantum_cnn_angle_vqc_dense_senokosov2024_input_1.png}};


\pic[shift={(2.6, 0.0, 0.0)}] at (0, 0, 0)
    {Box={
        name=Conv_1,
        fill=\ConvColor,
        opacity=0.82,
...
\pic[shift={(0.0, 0.0, 0.0)}] at (Conv_1-east)
    {Box={
        name=Norm_2,
        fill=\NormColor,
        opacity=0.82,
...
\pic[shift={(0.0, 0.0, 0.0)}] at (Norm_2-east)
    {Box={
        name=Act_3,
...
\pic[shift={(0.0, 0.0, 0.0)}] at (Act_3-east)
    {Box={
        name=Pool_4,
        fill=\PoolColor,
        opacity=0.82,
        caption={\scriptsize \shortstack{Conv($5\!\times\!5$) + BN + ReLU\\MaxPool($2\!\times\!2$)\\$1\!\times\!16\!\times\!16 \rightarrow 16\!\times\!8\!\times\!8$}},
        width=1.0,
        height=1.275,
        depth=1.275
        }
...
\pic[shift={(4.2, 0.0, 0.0)}] at (Pool_4-east)
    {Box={
        name=Conv_5,
        fill=\ConvColor,
        opacity=0.82,
...
\pic[shift={(0.0, 0.0, 0.0)}] at (Norm_6-east)
    {Box={
        name=Act_7,
        fill=\ActivationColor,
        opacity=0.82,
...
\pic[shift={(0.0, 0.0, 0.0)}] at (Act_7-east)
    {Box={
        name=Pool_8,
        fill=\PoolColor,
        opacity=0.82,
        caption={\scriptsize \shortstack{Conv($5\!\times\!5$) + BN + ReLU\\MaxPool($2\!\times\!2$)\\$16\!\times\!8\!\times\!8 \rightarrow 32\!\times\!4\!\times\!4$}},
        width=1,
        height=1,
        depth=1
        }
...
\pic[shift={(4.2, 0.0, 0.0)}] at (Pool_8-east)
    {Box={
        name=Linear_9,
        fill={rgb,255:red,118;green,183;blue,178},
        opacity=0.82,
        caption={\scriptsize \shortstack{Flatten + Linear\\BN + ReLU\\$512 \rightarrow 9$}},
        width=1,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(0.0, 0.0, 0.0)}] at (Linear_9-east)
    {Box={
        name=Norm_10,
        fill=\NormColor,
        opacity=0.82,
        ...
        width=1,
        height=1.55,
        depth=3.1359375000000003
        }
    };


\pic[shift={(0.0, 0.0, 0.0)}] at (Norm_10-east)
    {Box={
        name=Act_11,
        fill=\ActivationColor,
        opacity=0.82,
...
\pic[shift={(2.6, 0.0, 0.0)}] at (Act_11-east)
    {Box={
        name=LinearAct_12,
        fill={rgb,255:red,111;green,76;blue,155},
        opacity=0.82,
        caption={\scriptsize \shortstack{$R_x$ embedding + VQC\\$q=9$, $L=1$\\$9 \rightarrow 512$}},
        width=2.0,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(2.6, 0.0, 0.0)}] at (LinearAct_12-east)
    {RightBandedBox={
        name=LinearAct_13,
        fill={rgb,255:red,178;green,121;blue,162},
        opacity=0.82,
        caption={\scriptsize \shortstack{Linear\\$512 \rightarrow 10$; LogSoftmax}},
        width=1,
        height=3.5,
        depth=3.5,
...
\draw [connection] (Pool_4-east) -- node {\midarrow} (Conv_5-west);
\draw [connection] (Pool_8-east) -- node {\midarrow} (Linear_9-west);
\draw [connection] (Act_11-east) -- node {\midarrow} (LinearAct_12-west);
\draw [connection] (LinearAct_12-east) -- node {\midarrow} (LinearAct_13-west);

\draw [connection] (ImgInput_1.east) -- node {\midarrow} (Conv_1-west);
\node[below=5pt of ImgInput_1, font=\bfseries\scriptsize, align=center] {Input\\$1\!\times\!16\!\times\!16$};
\path (current bounding box.east) ++(3cm,0) node[inner sep=0pt] {};
\end{tikzpicture}
\end{document}
