...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_adaptive_qnn_no_qnn_inspired_dense_input_1.png}};
...
\pic[shift={(3.2, 0.0, 0.0)}] at (LinearAct_1-east)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Adaptive QCNN\\No-QNN-inspired convolution + pooling\\$q_{in}=q$, $q_{out}=4$}},
        width=2.25,
        height=3.5,
        depth=3.5
        }
