...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_frqi_cnn_feature_maps_vqc_dense_input_1.png}};
...
\pic[shift={(3.6, 0.0, 0.0)}] at (Pool_8-east)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{GEQIE/FRQI + VQC per feature map\\$16$ maps; $q=5$, $L=1$\\Flatten: $16\!\times\!32 \rightarrow 512$}},
        width=2.5,
        height=3.5,
        depth=3.5
        }
