...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_neqr_direct_vqc_dense_input_1.png}};
...
\pic[shift={(3.2, 0.0, 0.0)}] at (LinearAct_1-east)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Variational quantum circuit\\$q=12$, $L=5$\\$12 \rightarrow 4096$}},
        width=2.25,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(3.0, 0.0, 0.0)}] at (LinearAct_2-east)
    {RightBandedBox={
        name=LinearAct_3,
