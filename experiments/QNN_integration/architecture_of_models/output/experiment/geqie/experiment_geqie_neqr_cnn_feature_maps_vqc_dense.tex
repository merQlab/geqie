...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_neqr_cnn_feature_maps_vqc_dense_input_1.png}};
...
\pic[shift={(3.6, 0.0, 0.0)}] at (Pool_8-east)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{GEQIE/NEQR + VQC per feature map\\$16$ maps; $q=8$, $L=1$\\Flatten: $16\!\times\!256 \rightarrow 4096$}},
        width=2.5,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(5.2, 0.0, 0.0)}] at (LinearAct_9-east)
    {RightBandedBox={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Linear\\$4096 \rightarrow 10$; LogSoftmax}},
        width=1,
        height=3.5,
        depth=3.5,
