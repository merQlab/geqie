...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_adaptive_qnn_no_qnn_inspired_qnn_compression_dense_input_1.png}};
...
\pic[shift={(2.0, 0.0, 0.0)}] at (0, 0, 0)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{GEQIE encoding\\$16\!\times\!16 \rightarrow q$}},
        width=3.5,
        height=1.0,
        depth=1.125
        }
...
\pic[shift={(3.2, 0.0, 0.0)}] at (LinearAct_1-east)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Adaptive QCNN + QNN compression\\No-QNN-inspired convolution + pooling\\$q_{in}=q$, $q_{out}=4$}},
        width=2.25,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(6.0, 0.0, 0.0)}] at (LinearAct_2-east)
    {RightBandedBox={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Linear\\$2^q \rightarrow 10$; LogSoftmax}},
        width=1.0,
        height=3.5,
        depth=3.5,
