...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_direct_vqc_dense_input_1.png}};
...
\pic[shift={(3.2, 0.0, 0.0)}] at (LinearAct_1-east)
    {Box={
        ...
        opacity=0.82,
        caption={\scriptsize \shortstack{Variational quantum circuit\\$q$ qubits, $L=5$\\$q \rightarrow 2^q$}},
        width=2.25,
        height=3.5,
        depth=3.5
        }
