...
\node[canvas is zy plane at x=0] (ImgInput_1) at (0, 0, 0) {\includegraphics[width=1.2cm, height=1.2cm]{experiment_geqie_frqi_adaptive_qnn_no_qnn_inspired_qnn_compression_dense_input_1.png}};


\pic[shift={(2.0, 0.0, 0.0)}] at (0, 0, 0)
    {Box={
        name=LinearAct_1,
        fill={rgb,255:red,89;green,161;blue,79},
        opacity=0.82,
        caption={\scriptsize \shortstack{GEQIE/FRQI encoding\\$16\!\times\!16 \rightarrow q=9$}},
        width=3.5,
        height=1.0,
        depth=1.125
        }
...
\pic[shift={(3.2, 0.0, 0.0)}] at (LinearAct_1-east)
    {Box={
        name=LinearAct_2,
        fill={rgb,255:red,111;green,76;blue,155},
        opacity=0.82,
        caption={\scriptsize \shortstack{Adaptive QCNN + QNN compression\\No-QNN-inspired convolution + pooling\\$q_{in}=9$, $q_{out}=4$}},
        width=2.25,
        height=3.5,
        depth=3.5
        }
...
\pic[shift={(6.0, 0.0, 0.0)}] at (LinearAct_2-east)
    {RightBandedBox={
        name=LinearAct_3,
...
\draw [connection] (LinearAct_1-east) -- node {\midarrow} (LinearAct_2-west);
\draw [connection] (LinearAct_2-east) -- node {\midarrow} (LinearAct_3-west);

\draw [connection] (ImgInput_1.east) -- node {\midarrow} (LinearAct_1-west);
