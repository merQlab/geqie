"""Baseline C: PCA -> ZZFeatureMap -> QNN -> Dense."""
...
try:
	from .common import DataBlock, load_mnist_digits_dataset, pca_image_loaders, run_subsets, train_model
except ImportError:
	import sys
...
class PCAZZQNNBaseline(nn.Module):
	def __init__(
		self,
		num_qubits: int = 12,
		num_layers: int = 1,
