"""Experiment B: GEQIE(NEQR, 4-bit) -> VQC -> Dense."""
...
def run(
	...
	**overrides,
	...
	zip_root = zip_root or DATASETS_DIR / ".precomputed_zips" / "neqr"
	if create_circuits:
	...
	return run_subsets(
		...
		pipeline_name="Experiment B",
		classifier_name="NEQR (4-bit) + QNN + Dense",
		model_architecture="GEQIE/NEQR matrices -> VQCLayer(default VQC) -> Dense -> LogSoftmax",
		num_classes=10,
		num_qubits=9,
		num_layers=5,
		epochs=50,
